...
for imsim, msim in enumerate(msims):
    ...
    #    print(msim)
    affine_from_metadata = msi_utils.get_transform_from_msim(
        msim, transform_key="affine_metadata"
    )
...
params = [
    si_utils.get_affine_from_sim(sim, transform_key="affine_metadata") for sim in sims
]
